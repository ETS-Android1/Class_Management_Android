...
public class NotificationFragment extends android.app.Fragment {
    ...
    private void showDialog(Activity activity, String idClassroomClick, String date){
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                mDatabaseAttendance.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot dataSnapshot : snapshot.child(acct.getUid()).child(idClassroomClick).child(date).getChildren()){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                generateDataPush();
                mDatabaseAttendance.child(acct.getUid()).child(idClassroomClick).child(date).setValue(mListDataPush);
