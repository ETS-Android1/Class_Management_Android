...
public class DbClassroomHelper extends SQLiteOpenHelper implements DbHelper
{
    ...
    public static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME
            ...
            + COLUMN_CLASSROOM_NAME + " text not null, " + COLUMN_TOTAL_STUDENT + " integer);";
    ...
    public List<Classroom> getList()
    {
        ...
        Cursor c = db.query(TABLE_NAME, new String[]{COLUMN_ID, COLUMN_SUBJECT_NAME, COLUMN_START_TIME,
                        COLUMN_END_TIME, COLUMN_CLASSROOM_NAME, COLUMN_TOTAL_STUDENT},
        ...
        if (c.moveToFirst()) {
            do {
                ...
                Classroom classManager = new Classroom(classID,className,startTime,endTime,classRoom,totalStudent);
    ...
    public Classroom get(String id)
    {
        ...
        if (c.moveToFirst())
        {
            ...
            String classRoom = c.getString(c.getColumnIndex(COLUMN_CLASSROOM_NAME));
            int totalStudent = c.getInt(c.getColumnIndex(COLUMN_TOTAL_STUDENT));
            classroom = new Classroom(id,className,startTime,endTime,classRoom,totalStudent);
        }
        else
            classroom = null;
        c.close();
    ...
    public List<Classroom> search(String searchText)
    {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                String classRoom = c.getString(c.getColumnIndex(COLUMN_CLASSROOM_NAME));
                int totalStudent = c.getInt(c.getColumnIndex(COLUMN_TOTAL_STUDENT));
                Classroom classroom = new Classroom(classID,className,startTime,endTime,classRoom,totalStudent);
